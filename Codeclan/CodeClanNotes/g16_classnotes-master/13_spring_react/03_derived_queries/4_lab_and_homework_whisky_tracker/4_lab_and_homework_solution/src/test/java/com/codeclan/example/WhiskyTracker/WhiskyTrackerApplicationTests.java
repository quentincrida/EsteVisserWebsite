...
public class WhiskyTrackerApplicationTests {
	...
	public void canGetAllWhiskiesFromRegionSpeyside(){
		List<Whisky> found = whiskyRepository.getAllWhiskiesByDistilleryRegion("Speyside");
	...
	public void canGetDistilleriesForWhiskiesAged(){
		List<Distillery> found = distilleryRepository.getDistilleriesByWhiskiesAge(12);
		assertEquals(2, found.size());
	}
}
