...
Most of these will be covered later in the course. Do not make any attempt to use them this week, even if you've used them before.
...
Project Briefs can be found [here](./projects/)

## Submission

The project submitted must be you're own work. You may be asked to talk through areas of code so please don't use code from stack overflow, etc if you don't understand it!
...
Presentations will be held on Thursday morning starting at 9:30. You will have 10 minutes to present your work, with 5 minutes for questions.

We expect you to:

* Show your sketches, notes, diagrams, wireframes and user planning
* Demonstrate your app's functionality
* Talk about some code that you are particularly proud of by using screenshots in your presentation .
...
Please remember that your fellow students are all working on their own projects.
